...
Para os campos do painel, use SEMPRE os numeros da foto (coluna ULTIMO e
coluna VARIACAO), e nao os do texto:
- DOLAR = linha USDBRL (4 casas decimais, ex "5,1117")
- DXY = linha DXY (3 casas decimais, ex "100,400")
- BRENT = linha IBRENT (2 casas decimais, ex "98,83")
- TNOTE = linha US10YY, arredondada para 2 casas decimais (ex "4,93")
- *_VAR = variacao da foto com sinal, ex "-1,12%" ou "+1,49%"
- *_COR = "pos" se a variacao for positiva, "neg" se negativa,
  "neu" se for zero (ex "-0,00%")
